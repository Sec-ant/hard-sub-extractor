...
class BarCodeReader:
    ...
    def __init__(self):
        ...
        preset_jar_file = osp.join(osp.join(os.getcwd(), 'pyzxing'),  preset_jar_filename)
        # print(preset_jar_file)
        if not osp.exists(preset_jar_file):
